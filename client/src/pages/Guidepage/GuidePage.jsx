    ...
    <MainWrapper classNames="bg-[#FFFCF8]">
      ...
      <section className="flex-1">
        <div className="w-full px-4 py-12">
          {/* Viktig: bredere venstre kolonne */}
          <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-[420px_1fr]">
            ...
            <aside className="flex flex-col items-start">
              ...
              <nav className="w-full space-y-6">
                <button className="w-full bg-[#488B90] hover:bg-[#214C50] px-8 py-6 text-left text-lg text-white shadow-none">
                  1. Lag modellen
                </button>
            ...
            <div className="w-full">
              <section className="w-full max-w-3xl rounded-2xl bg-white p-12 text-left shadow-lg">
